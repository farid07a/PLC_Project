...
class tag:
    ...
    # get list of object tag( ID_Tag, Name, Data_Type, Address_start_byte, Address_start_bit, ID_PLC)
    # list object created by self.get_data_tags_in_database_by_id_plc(id_plc)
    ...
    # get all tag obj
    # get list of object tag( ID_Tag, Name, Data_Type, Address_start_byte, Address_start_bit, ID_PLC)
    # list all object created by self.get_data_tags_in_database_by_id_plc()
    ...
    def get_size_db_by_id_plc(self, id_plc):
        list_tags = self.list_of_tags_by_id_plc(id_plc)
        size_list_tag = len(list_tags)
        print("Number of Tags :", size_list_tag)
        data_type_last_tag = list_tags[size_list_tag - 1].get_data_type()
        address_last_tag = list_tags[size_list_tag - 1].get_address_start_byte()
